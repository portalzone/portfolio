  ...
  <footer class="bg-gray-900 text-white mt-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <!-- About -->
        <div>
          <h3 class="text-xl font-bold mb-4">{{ profile?.name || 'Portfolio' }}</h3>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <router-link to="/projects" class="text-gray-400 hover:text-white transition">
                Projects
              </router-link>
            </li>
            <li>
              <router-link to="/blog" class="text-gray-400 hover:text-white transition">
                Blog
              </router-link>
            </li>
            <li>
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
        ...
        <p class="mt-2 text-sm">Built with Laravel & Vue.js</p>
      </div>
    </div>
  </footer>
</template>
